    ...
    do {
        ...
        switch (choice) {
            ...
            case 1: {
                ...
                string driversNum;
                char *drivesrsNumConvert;
                cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
                //cin >> numOfDrivers;
                getline(cin, driversNum);
                drivesrsNumConvert = (char *) driversNum.c_str();
                while (!isdigit(*drivesrsNumConvert) || atoi(drivesrsNumConvert) <= 0) {
                    cout << "-1\n";
                    //cin >> numOfDrivers;
                    cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
                    getline(cin, driversNum);
                ...
                numOfDrivers = atoi(drivesrsNumConvert);
